...
def roi_mask():
    ...
    polygon = np.array([[180,500], [180,220], [1100,220], [1100,500]])
...
def getBirdEye(img):
    ...
    road_coordinates=np.float32([ [380,220], [900,220], [1100,500],[180,500]])
