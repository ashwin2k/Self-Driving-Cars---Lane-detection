...
def roi_mask():
    ...
    polygon = np.array([[0,100], [100,71], [181,71], [278,100]]) 
...
def getBirdEye(img):
    ...
    road_coordinates=np.float32([[100,71], [181,71], [278,100],[0,100]])
...
def get_normal_view(img):
    ...
    result = cv2.warpPerspective(img, dest_matrix, (320,160))
    return result
...
def read_image(img):
    ...
    # cv2.imshow("Finalempty",empty_mat)
...
img = cv2.imread('/home/ashwin/edison-mk1/Conditional model/images/12.jpg')
# img=cv2.resize(img,(1280,720))
read_image(img)
